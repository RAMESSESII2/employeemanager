...
public class User implements Serializable{
    ...
    public String toString() {
        return "User [city=" + city + ", country=" + country + ", firstName=" + firstName + ", handle=" + handle
                + ", id=" + id + ", lastName=" + lastName + ", rating=" + rating + "]";
    }
    public User(){}
...
//     public User(){}
//     public User(long id, String lastName, String country, int lastOnlineTimeSeconds, String city, int rating,
//             int friendOfCount, String titlePhoto, String handle, String avatar, String firstName, int contribution,
//             String organization, String rank, int maxRating, int registrationTimeSeconds, String maxRank) {
//         this.id = id;
//         this.lastName = lastName;
//         this.country = country;
//         this.lastOnlineTimeSeconds = lastOnlineTimeSeconds;
